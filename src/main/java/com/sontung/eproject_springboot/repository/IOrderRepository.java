...
public interface IOrderRepository extends JpaRepository<Order, String> {
    ...
    @Query(
            "SELECT COUNT(o) FROM Order o WHERE DATE(o.orderDate) = :filterDate AND o.totalAmount BETWEEN :minAmount AND :maxAmount")
    long countOrderByFilterDateAndPrice(
    ...
    @Query(
            "SELECT o FROM Order o WHERE o.totalAmount >= :minPrice AND o.totalAmount <= :maxPrice AND DATE(o.orderDate) = :filterDate")
    ...
    List<OrderDTO> findByStatusAndOrderDateBefore(
            @Param("status") OrderStatus status, @Param("orderDate") LocalDateTime orderDate);
}
