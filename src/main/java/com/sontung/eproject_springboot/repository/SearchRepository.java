...
public interface SearchRepository {
    ...
    Page<Order> getAllOrderWithSortByColoumAndSearch(
            int pageNo, int pageSize, String search, String sortBy, String status, String accountId);

    Page<Product> getAllProductWithSortByColumAndSearch(
            int pageNo,
            int pageSize,
            String search,
            int amongPrice,
    ...
    Page<Order> getAllOrderWithSortByColoumAndSearchCriteriaBuider(
            int pageNo, int pageSize, String search, String status, String sortBy, String accountId);

    Page<Order> getAllOrderWithFilterDateAmongPriceAndSearchCriteriaBuider(
            int pageNo,
            int pageSize,
            String search,
            int amongPrice,
    ...
    Page<Product> findByStatusAndProductNameContainingAndPriceFilter(
